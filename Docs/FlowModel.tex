...
Some theory of everting tubes has been reviewed above.  Recently,  Lewis \cite{xxxx} measured some complex dynamic behaviors of a tube everting
inside
a straight support tube of approximately the same diameter as the inflated tubing material (Figure \ref{Fig:experData}, Left panel).
